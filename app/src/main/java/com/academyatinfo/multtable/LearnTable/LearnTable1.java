...
public class LearnTable1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learntable1);
    ...
    public void level_one(View view) {
        intent = new Intent(this, LearnTable2.class);
    ...
    public void level_two(View view) {
        if (dataBaseLearn.getData(table, 1)) {
            intent = new Intent(this, LearnTable3.class);
